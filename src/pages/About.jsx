...
import { Thirdprompt2, Thirdpromptdiv1, Thirdpromptdiv2, Thirdpromptdiv3, Thirdpromptdiv4, Whybox } from './Landing'
...
const About = () => {
  ...
  <Whoweare>
   ...
   <P1>Who We Are</P1>
    ...
    <Left>
    <P2>At IdeaFundr we are passionate about helping product owners succeed by connecting them with potential investors.
...
offers valuable resources and support to help product owners navigate the investment landscape.</P2>
  ...
  <Thirdprompt2>
        ...
        <Thirdpromptdiv2>
            <p>With our inbuilt tool inventor can track the progress and receive feedback on their profile, so that they can continuously improve it and increase their chance of funding.
                 </p>
        </Thirdpromptdiv2>
        <Thirdpromptdiv3>
        ...
        <Thirdpromptdiv4>
            <p>With our inbuilt tool investor can easily evaluate the potential of an invention to make informed investment decision.
                 </p>
        </Thirdpromptdiv4>
        </Thirdprompt2>
        <Whoweare>
...
We prioritize the security and privacy of your information. Our platform employs state-of-the-art security measures, such as encryption and strict data privacy protocols, to safeguard your data and ensure a safe and trustworthy environment for investment transactions.

IdeaFundr continuously strive to improve and enhance our platform based on user feedback and market trends. We are committed to delivering a user-friendly experience</P2>
    </Left>
        </Whoweare>
        <Coming2/>
        <Newsletter/>
